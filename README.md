...
- **Headless test suite**: 35 checks — the floors as numbers, 200-seed passability,
...
node test-harness.js         # 35-check headless suite
```
...
│   ├── test-harness.js      # headless Node driver + 35-check suite
